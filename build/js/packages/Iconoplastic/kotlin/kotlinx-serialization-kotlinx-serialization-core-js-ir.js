(function (root, factory) {
  ...
  var IllegalArgumentException_init_$Init$_1 = kotlin_kotlin.$_$.a2;
  ...
  var Triple = kotlin_kotlin.$_$.rc;
  var Pair = kotlin_kotlin.$_$.nc;
  var LinkedHashMap = kotlin_kotlin.$_$.o4;
  var MutableMap = kotlin_kotlin.$_$.w4;
  var HashMap = kotlin_kotlin.$_$.k4;
  var LinkedHashSet = kotlin_kotlin.$_$.p4;
  var MutableSet = kotlin_kotlin.$_$.x4;
  var Set = kotlin_kotlin.$_$.y4;
  var HashSet = kotlin_kotlin.$_$.l4;
  var ArrayList = kotlin_kotlin.$_$.h4;
  var MutableList = kotlin_kotlin.$_$.u4;
  var List = kotlin_kotlin.$_$.q4;
  var Collection = kotlin_kotlin.$_$.i4;
  var equals = kotlin_kotlin.$_$.t8;
  var Iterator = kotlin_kotlin.$_$.n4;
  var Iterable = kotlin_kotlin.$_$.m4;
  ...
  var UInt = kotlin_kotlin.$_$.tc;
  var _UInt___init__impl__l7qpdl = kotlin_kotlin.$_$.e3;
  var _ULong___get_data__impl__fggpzb = kotlin_kotlin.$_$.i3;
  var ULong = kotlin_kotlin.$_$.uc;
  var _ULong___init__impl__c78o9k = kotlin_kotlin.$_$.h3;
  var ByteCompanionObject_getInstance = kotlin_kotlin.$_$.q3;
  var _UByte___get_data__impl__jof9qr = kotlin_kotlin.$_$.c3;
  var UByte = kotlin_kotlin.$_$.sc;
  var _UByte___init__impl__g9hnc4 = kotlin_kotlin.$_$.b3;
  var ShortCompanionObject_getInstance = kotlin_kotlin.$_$.u3;
  ...
  var KTypeParameter = kotlin_kotlin.$_$.ka;
  var HashSet_init_$Create$_1 = kotlin_kotlin.$_$.b1;
  var contentHashCode = kotlin_kotlin.$_$.g5;
  ...
  var DoubleCompanionObject_getInstance = kotlin_kotlin.$_$.r3;
  var isDoubleArray = kotlin_kotlin.$_$.f9;
  var FloatCompanionObject_getInstance = kotlin_kotlin.$_$.s3;
  ...
  var BooleanCompanionObject_getInstance = kotlin_kotlin.$_$.p3;
  var isBooleanArray = kotlin_kotlin.$_$.b9;
  var coerceAtLeast = kotlin_kotlin.$_$.x9;
  var copyOf = kotlin_kotlin.$_$.k5;
  var copyOf_0 = kotlin_kotlin.$_$.m5;
  var copyOf_1 = kotlin_kotlin.$_$.n5;
  var copyOf_2 = kotlin_kotlin.$_$.i5;
  var copyOf_3 = kotlin_kotlin.$_$.p5;
  var copyOf_4 = kotlin_kotlin.$_$.h5;
  var copyOf_5 = kotlin_kotlin.$_$.l5;
  var copyOf_6 = kotlin_kotlin.$_$.j5;
  var Unit = kotlin_kotlin.$_$.wc;
  var trimIndent = kotlin_kotlin.$_$.wb;
  ...
  var titlecase = kotlin_kotlin.$_$.jb;
  var isLowerCase = kotlin_kotlin.$_$.za;
  ...
  var get_lastIndex_0 = kotlin_kotlin.$_$.e6;
  var get_indices = kotlin_kotlin.$_$.c6;
  var IndexOutOfBoundsException_init_$Create$ = kotlin_kotlin.$_$.i2;
  var get_indices_0 = kotlin_kotlin.$_$.b6;
  ...
  function PolymorphicSerializer$descriptor$delegate$lambda$lambda(this$0) {
    return function ($this$buildSerialDescriptor) {
      var tmp = serializer_2(StringCompanionObject_getInstance()).get_descriptor_wjt6a0_k$();
    ...
    if (failOnMissingTypeArgSerializer) {
      var tmp$ret$1;
      {
        var tmp$ret$0;
        {
          ...
          while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var item = tmp0_iterator.next_20eer_k$();
            tmp0_mapTo.add_1j60pz_k$(serializer_1(_this__u8e3s4, item));
          }
  ...
  function ULongSerializer() {
    ...
    this.descriptor_1 = InlinePrimitiveDescriptor('kotlin.ULong', serializer_6(Companion_getInstance()));
  }
  ...
  function UByteSerializer() {
    ...
    this.descriptor_1 = InlinePrimitiveDescriptor('kotlin.UByte', serializer_9(ByteCompanionObject_getInstance()));
  }
  ...
  function init_properties_Primitives_kt_u7dn2q() {
    if (properties_initialized_Primitives_kt_6dpii6) {
      ...
      BUILTIN_SERIALIZERS = mapOf([to(PrimitiveClasses_getInstance().get_stringClass_bik2gy_k$(), serializer_2(StringCompanionObject_getInstance())), to(getKClass(Char), serializer_3(Companion_getInstance_0())), to(PrimitiveClasses_getInstance().get_charArrayClass_7lhfoe_k$(), CharArraySerializer()), to(PrimitiveClasses_getInstance().get_doubleClass_dahzcy_k$(), serializer_4(DoubleCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_doubleArrayClass_84hee1_k$(), DoubleArraySerializer()), to(PrimitiveClasses_getInstance().get_floatClass_xlwq2t_k$(), serializer_5(FloatCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_floatArrayClass_qngmha_k$(), FloatArraySerializer()), to(getKClass(Long), serializer_6(Companion_getInstance())), to(PrimitiveClasses_getInstance().get_longArrayClass_v379a4_k$(), LongArraySerializer()), to(PrimitiveClasses_getInstance().get_intClass_mw4y9a_k$(), serializer_7(IntCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_intArrayClass_h44pbv_k$(), IntArraySerializer()), to(PrimitiveClasses_getInstance().get_shortClass_5ajsv9_k$(), serializer_8(ShortCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_shortArrayClass_c1p7wy_k$(), ShortArraySerializer()), to(PrimitiveClasses_getInstance().get_byteClass_pu7s61_k$(), serializer_9(ByteCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_byteArrayClass_57my8g_k$(), ByteArraySerializer()), to(PrimitiveClasses_getInstance().get_booleanClass_d285fr_k$(), serializer_10(BooleanCompanionObject_getInstance())), to(PrimitiveClasses_getInstance().get_booleanArrayClass_lnbwea_k$(), BooleanArraySerializer()), to(getKClass(Unit), serializer_11(Unit_getInstance()))]);
    }
  }
  ...
  _.$_$.z1 = get_EmptySerializersModule;
  _.$_$.a2 = contextual;
  _.$_$.b2 = polymorphicDefault;
