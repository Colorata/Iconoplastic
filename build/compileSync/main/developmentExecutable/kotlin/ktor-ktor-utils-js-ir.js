(function (root, factory) {
  ...
  var MutableEntry = kotlin_kotlin.$_$.v4;
  ...
  var CoroutineExceptionHandler = kotlin_org_jetbrains_kotlinx_kotlinx_coroutines_core.$_$.a1;
  var MutableIterator = kotlin_kotlin.$_$.t4;
  ...
  var get_lastIndex = kotlin_kotlin.$_$.cb;
  ...
  var HashMap_init_$Create$ = kotlin_kotlin.$_$.a1;
  ...
  var mutableListOf = kotlin_kotlin.$_$.n6;
  ...
  function get_0(key) {
    var tmp0_elvis_lhs = this.getOrNull_dkmqfg_k$(key);
    var tmp;
  ...
  function take(key) {
    var tmp$ret$0;
    {
      var tmp0_also = this.get_g4gx7m_k$(key);
      {
      }
      {
        this.remove_kvks5b_k$(key);
      }
      tmp$ret$0 = tmp0_also;
    }
    return tmp$ret$0;
  ...
  function takeOrNull(key) {
    var tmp$ret$0;
    {
      var tmp0_also = this.getOrNull_dkmqfg_k$(key);
      {
      }
      {
        this.remove_kvks5b_k$(key);
  ...
  InternalAPI.$metadata$ = classMeta('InternalAPI', [Annotation]);
  function KtorDsl() {
  }
  ...
  KtorDsl.$metadata$ = classMeta('KtorDsl', [Annotation]);
  ...
  function putAll(_this__u8e3s4, other) {
    {
      ...
      while (tmp0_iterator.hasNext_bitz1p_k$()) {
        var element = tmp0_iterator.next_20eer_k$();
        {
          _this__u8e3s4.put_ii1a3j_k$(element instanceof AttributeKey ? element : THROW_CCE(), other.get_g4gx7m_k$(element));
        }
      }
    }
  }
  ...
  function CaseInsensitiveMap$_get_keys_$lambda_ptzlqj() {
    return function ($this$$receiver) {
      return $this$$receiver.content_1;
    };
  }
  ...
  function CaseInsensitiveMap$_get_entries_$lambda_r32w19() {
    return function ($this$$receiver) {
      return new Entry_0($this$$receiver.get_key_18j28a_k$().content_1, $this$$receiver.get_value_j01efc_k$());
    };
  }
    ...
    var tmp$ret$4;
    {
      var tmp$ret$3;
      {
        ...
        var tmp$ret$2;
        {
          ...
          var tmp$ret$0;
          {
            tmp$ret$0 = tmp0_filter.get_entries_p20ztl_k$().iterator_jk1svi_k$();
          }
          var tmp0_iterator = tmp$ret$0;
          while (tmp0_iterator.hasNext_bitz1p_k$()) {
            var element = tmp0_iterator.next_20eer_k$();
      ...
      var tmp1_iterator = tmp$ret$3;
      tmp$ret$4 = tmp1_iterator.get_entries_p20ztl_k$().iterator_jk1svi_k$();
    }
  ...
  CopyOnWriteHashMap.prototype.put_3mhbri_k$ = function (key, value) {
    do {
      var old = this.current_1.value_1;
  ...
  CopyOnWriteHashMap.prototype.get_1mhr4y_k$ = function (key) {
    return this.current_1.value_1.get_1mhr4y_k$(key);
  };
  ...
  function _set_interceptors__wod97b_0($this, value) {
    $this._interceptors_1.value_1 = value;
  }
  function _get_interceptors__h4min7_1($this) {
    return $this._interceptors_1.value_1;
  }
    ...
    var fromPhases = from.phasesRaw_1;
    {
      ...
      while (tmp0_iterator.hasNext_bitz1p_k$()) {
        var element = tmp0_iterator.next_20eer_k$();
        {
          ...
          var tmp;
          if (tmp0_elvis_lhs == null) {
            tmp = (element instanceof PhaseContent ? element : THROW_CCE()).phase_1;
          } else {
            tmp = tmp0_elvis_lhs;
          }
          var fromPhase = tmp;
    ...
    if (inductionVariable <= last)
      $l$loop_0: do {
        ...
        if (fromPhaseOrContent instanceof PhaseContent)
          ...
          THROW_CCE();
        $this.phasesRaw_1.add_1j60pz_k$(new PhaseContent(fromPhaseOrContent.phase_1, fromPhaseOrContent.relation_1, fromPhaseOrContent.sharedInterceptors_rmg8b1_k$()));
        continue $l$loop_0;
      }
       while (!(index === last));
    var tmp1_this = $this;
  ...
  function insertRelativePhase($this, fromPhaseOrContent, fromPhase) {
    ...
    if (fromPhaseOrContent === fromPhase) {
      ...
      tmp = (fromPhaseOrContent instanceof PhaseContent ? fromPhaseOrContent : THROW_CCE()).relation_1;
    }
    ...
    if (fromPhaseRelation instanceof Last)
      ...
      if (fromPhaseRelation instanceof Before) {
        tmp_0 = hasPhase($this, fromPhaseRelation.relativeTo_1);
      } else {
        tmp_0 = false;
      }
      if (tmp_0)
        $this.insertPhaseBefore_mtrcmo_k$(fromPhaseRelation.relativeTo_1, fromPhase);
      else {
        if (fromPhaseRelation instanceof After)
          $this.insertPhaseAfter_v4shih_k$(fromPhaseRelation.relativeTo_1, fromPhase);
        else {
          return false;
        }
      }
        ...
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
          ...
          var tmp$ret$0;
          {
            ...
            if (tmp1_elvis_lhs == null) {
              ...
              tmp = ensureNotNull(tmp0_safe_receiver == null ? null : tmp0_safe_receiver.phase_1);
            } else {
              tmp = tmp1_elvis_lhs;
            }
            tmp$ret$0 = tmp;
  ...
  Pipeline.prototype.insertPhaseAfter_v4shih_k$ = function (reference, phase) {
    ...
    if (inductionVariable <= last)
      $l$loop_0: do {
        ...
        var tmp2_elvis_lhs = tmp1_safe_receiver == null ? null : tmp1_safe_receiver.relation_1;
        var tmp_0;
        ...
        var tmp4_elvis_lhs = tmp3_safe_receiver == null ? null : tmp3_safe_receiver.relativeTo_1;
        var tmp_1;
  ...
  Pipeline.prototype.interceptorsForPhase_thlg9s_k$ = function (phase) {
    ...
    $l$block: {
      ...
      var tmp1_firstOrNull = tmp$ret$1;
      var tmp0_iterator_0 = tmp1_firstOrNull.iterator_jk1svi_k$();
      while (tmp0_iterator_0.hasNext_bitz1p_k$()) {
        var element_0 = tmp0_iterator_0.next_20eer_k$();
        var tmp$ret$2;
        {
          tmp$ret$2 = equals(element_0.phase_1, phase);
        }
        if (tmp$ret$2) {
          tmp$ret$3 = element_0;
          break $l$block;
  ...
  Pipeline.prototype.mergePhases_9ldwy7_k$ = function (from) {
    ...
    $l$loop: while (true) {
      ...
      while (iterator.hasNext_bitz1p_k$()) {
        ...
        var tmp;
        if (tmp0_elvis_lhs == null) {
          tmp = (fromPhaseOrContent instanceof PhaseContent ? fromPhaseOrContent : THROW_CCE()).phase_1;
        } else {
          tmp = tmp0_elvis_lhs;
        }
        var fromPhase = tmp;
  ...
  StackWalkingFailed.$metadata$ = objectMeta('StackWalkingFailed');
  ...
  StackWalkingFailedFrame.$metadata$ = objectMeta('StackWalkingFailedFrame', [CoroutineStackFrame, Continuation]);
  ...
  function peekContinuation($this) {
    if ($this.currentIndex_1 === IntCompanionObject_getInstance().MIN_VALUE_1)
      $this.currentIndex_1 = $this.this$0__1.lastSuspensionIndex_1;
    if ($this.currentIndex_1 < 0) {
      $this.currentIndex_1 = IntCompanionObject_getInstance().MIN_VALUE_1;
      return null;
    }
    try {
  ...
  function resumeRootWith($this, result) {
    ...
    if (!_Result___get_isFailure__impl__jpiriv(result)) {
      ...
      var tmp$ret$1;
      {
        ...
        tmp$ret$1 = next.resumeWith_s3a3yh_k$(tmp$ret$0);
      }
    }
  }
  ...
  AttributesJs.prototype.getOrNull_dkmqfg_k$ = function (key) {
  ...
  AttributesJs.prototype.put_ii1a3j_k$ = function (key, value) {
    {
      var tmp0_set = this.map_1;
      tmp0_set.put_3mhbri_k$(key, value);
    }
  };
  AttributesJs.prototype.remove_kvks5b_k$ = function (key) {
    this.map_1.remove_8hbkc0_k$(key);
  };
  AttributesJs.prototype.computeIfAbsent_ia69ed_k$ = function (key, block) {
  ...
  AttributesJs.prototype.get_g4gx7m_k$ = get_0;
  AttributesJs.prototype.take_uyss19_k$ = take;
  AttributesJs.prototype.takeOrNull_5eqmpp_k$ = takeOrNull;
  //endregion
  //region block: init
