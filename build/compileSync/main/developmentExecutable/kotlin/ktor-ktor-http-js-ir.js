(function (root, factory) {
  ...
  var prepareReadFirstHead = kotlin_io_ktor_ktor_io.$_$.w;
  var prepareReadNextHead = kotlin_io_ktor_ktor_io.$_$.x;
  var completeReadHead = kotlin_io_ktor_ktor_io.$_$.v;
  ...
  var isSurrogate = kotlin_kotlin.$_$.ab;
  ...
  var isBlank = kotlin_kotlin.$_$.wa;
  ...
  var get_lastIndex = kotlin_kotlin.$_$.e6;
  var last_0 = kotlin_kotlin.$_$.db;
  var first = kotlin_kotlin.$_$.va;
  var get_lastIndex_0 = kotlin_kotlin.$_$.cb;
  ...
  var rangeTo = kotlin_kotlin.$_$.da;
  var LazyThreadSafetyMode_NONE_getInstance = kotlin_kotlin.$_$.e;
  var lazy_0 = kotlin_kotlin.$_$.hd;
  ...
  var lineSequence = kotlin_kotlin.$_$.eb;
  var mapNotNull = kotlin_kotlin.$_$.ma;
  var toList = kotlin_kotlin.$_$.pa;
  var removePrefix = kotlin_kotlin.$_$.fb;
  var toLowerCasePreservingASCIIRules = kotlin_io_ktor_ktor_utils.$_$.c1;
  var StringValuesBuilder = kotlin_io_ktor_ktor_utils.$_$.t;
  var isWhitespace = kotlin_kotlin.$_$.bb;
  ...
  var first_0 = kotlin_kotlin.$_$.z5;
  ...
  var dropLast = kotlin_kotlin.$_$.r5;
  ...
  var take = kotlin_kotlin.$_$.ib;
  var firstOrNull = kotlin_kotlin.$_$.x5;
  ...
  NoCache.prototype.toString = function () {
    var tmp;
    if (this.get_visibility_bxkfbv_k$() == null) {
      tmp = 'no-cache';
    } else {
      tmp = 'no-cache, ' + this.get_visibility_bxkfbv_k$().headerValue_1;
    }
    return tmp;
  };
  NoCache.prototype.equals = function (other) {
    ...
    if (other instanceof NoCache) {
      tmp = equals(this.get_visibility_bxkfbv_k$(), other.get_visibility_bxkfbv_k$());
    } else {
      tmp = false;
    }
    return tmp;
  ...
  NoCache.prototype.hashCode = function () {
    var tmp$ret$0;
    {
      var tmp0_hashCode = this.get_visibility_bxkfbv_k$();
  ...
  NoCache.$metadata$ = classMeta('NoCache', undefined, undefined, undefined, undefined, CacheControl.prototype);
  ...
  NoStore.prototype.toString = function () {
    ...
    if (this.get_visibility_bxkfbv_k$() == null) {
      ...
      tmp = 'no-store, ' + this.get_visibility_bxkfbv_k$().headerValue_1;
    }
    return tmp;
  };
  NoStore.prototype.equals = function (other) {
    ...
    if (other instanceof NoStore) {
      tmp = equals(other.get_visibility_bxkfbv_k$(), this.get_visibility_bxkfbv_k$());
    } else {
      tmp = false;
    }
    return tmp;
  ...
  NoStore.$metadata$ = classMeta('NoStore', undefined, undefined, undefined, undefined, CacheControl.prototype);
  ...
  MaxAge.prototype.toString = function () {
    ...
    if (!(this.get_visibility_bxkfbv_k$() == null)) {
      parts.add_1j60pz_k$(this.get_visibility_bxkfbv_k$().headerValue_1);
    }
  ...
  MaxAge.prototype.equals = function (other) {
    ...
    if (other === this) {
      ...
      if (tmp_1) {
        tmp_0 = equals(other.get_visibility_bxkfbv_k$(), this.get_visibility_bxkfbv_k$());
      } else {
        tmp_0 = false;
      }
      tmp = tmp_0;
  ...
  MaxAge.$metadata$ = classMeta('MaxAge', undefined, undefined, undefined, undefined, CacheControl.prototype);
  ...
  CacheControl.$metadata$ = classMeta('CacheControl');
  ...
  function encodeURLParameter(_this__u8e3s4, spaceToPlus) {
    ...
    var tmp$ret$1;
    {
      ...
      var tmp$ret$0;
      {
        ...
        {
          var tmp = Charsets_getInstance().UTF_8__1.newEncoder_gqwcdg_k$();
        ...
        $l$loop_1: do {
          var tmp$ret$2;
          {
            ...
            $l$loop: while (true) {
              var tmp$ret$1;
              {
                tmp$ret$1 = tmp0__anonymous__q1qw7t.writePosition_1 > tmp0__anonymous__q1qw7t.readPosition_1;
              }
              if (!tmp$ret$1) {
                break $l$loop;
              }
  ...
  function encodeURLParameter$lambda($tmp0_apply, $spaceToPlus) {
    return function (it) {
      var tmp;
      if (get_URL_ALPHABET().contains_2ehdt1_k$(it) ? true : get_OAUTH_SYMBOLS().contains_2ehdt1_k$(it)) {
    ...
    if (properties_initialized_Codecs_kt_hkj9s1) {
      ...
      var tmp$ret$3_0;
      {
        ...
        var tmp$ret$2_0;
        {
          ...
          var tmp0_iterator_0 = tmp0_map_0.iterator_jk1svi_k$();
      ...
      var tmp$ret$3_1;
      {
        ...
        var tmp$ret$2_1;
        {
          ...
          var tmp0_iterator_1 = tmp0_map_1.iterator_jk1svi_k$();
    ...
    switch (tmp0_subject) {
      ...
      case 1:
        var tmp$ret$1;
        {
          ...
          var tmp$ret$0;
          {
            tmp$ret$0 = equals_0(tmp0_let.name_1, name, true) ? equals_0(tmp0_let.value_1, value, true) : false;
          }
          tmp$ret$1 = tmp$ret$0;
        }
      ...
      default:
        ...
        $l$block_0: {
          ...
          while (tmp0_iterator.hasNext_bitz1p_k$()) {
            ...
            var tmp$ret$3;
            {
              tmp$ret$3 = equals_0(element.name_1, name, true) ? equals_0(element.value_1, value, true) : false;
            }
            if (tmp$ret$3) {
              tmp$ret$2 = true;
              break $l$block_0;
  ...
  Companion.prototype.parse_4mmrzm_k$ = function (value) {
    ...
    var tmp$ret$10;
    {
      ...
      var tmp$ret$9;
      {
        var tmp1__anonymous__uwfjfc = headerValue.value_1;
        var tmp2__anonymous__z9zvc9 = headerValue.params_1;
  ...
  Audio.$metadata$ = objectMeta('Audio');
  var Audio_instance;
  ...
  Image.$metadata$ = objectMeta('Image');
  var Image_instance;
  ...
  Message.$metadata$ = objectMeta('Message');
  ...
  Video.$metadata$ = objectMeta('Video');
  var Video_instance;
        ...
        if (tmp3_subject === '*') {
          ...
          $l$block_0: {
            ...
            while (tmp0_iterator_0.hasNext_bitz1p_k$()) {
              ...
              var tmp$ret$1;
              {
                tmp$ret$1 = equals_0(element.value_1, patternValue, true);
              }
              if (tmp$ret$1) {
                tmp$ret$0 = true;
                break $l$block_0;
    ...
    var tmp$ret$12;
    {
      ...
      var tmp$ret$11;
      {
        ...
        var tmp$ret$10;
        {
          ...
          var tmp0_iterator_0 = tmp0_associateByTo.iterator_jk1svi_k$();
          while (tmp0_iterator_0.hasNext_bitz1p_k$()) {
            ...
            var tmp$ret$9;
            {
              var tmp$ret$8;
              {
                var tmp0_map = element_0.get_value_j01efc_k$();
                var tmp$ret$7;
                {
                  var tmp0_mapTo = ArrayList_init_$Create$(collectionSizeOrDefault(tmp0_map, 10));
            ...
            tmp1_mapValuesTo.put_3mhbri_k$(tmp_0, tmp$ret$9);
          }
          tmp$ret$10 = tmp1_mapValuesTo;
        }
  ...
  function extensionsByContentType$delegate$lambda$lambda() {
  ...
  Companion_0.prototype.parse_945lsl_k$ = function (value, init) {
    var headerValue = last(parseHeaderValue(value));
    return init(headerValue.value_1, headerValue.params_1);
  };
  ...
  HeaderValueWithParameters.prototype.parameter_rthy20_k$ = function (name) {
    ...
    if (inductionVariable <= last)
      do {
        ...
        if (equals_0(parameter.name_1, name, true)) {
          return parameter.value_1;
        }
      }
       while (!(index === last));
    return null;
    ...
    if (this.parameters_1.isEmpty_y1axqb_k$()) {
      ...
      var tmp$ret$1;
      {
        ...
        while (tmp0_iterator.hasNext_bitz1p_k$()) {
          ...
          var tmp$ret$0;
          {
            tmp$ret$0 = (element.name_1.length + element.value_1.length | 0) + 3 | 0;
          }
        ...
        }
        {
          ...
          if (inductionVariable <= last)
            do {
              ...
              tmp1_apply.append_ssq29y_k$(element_0.name_1);
              tmp1_apply.append_ssq29y_k$('=');
              {
                var tmp0_escapeIfNeededTo = element_0.value_1;
  ...
  function contentType(_this__u8e3s4) {
    var tmp0_safe_receiver = _this__u8e3s4.get_headers_ef25jx_k$().get_4u8u51_k$(HttpHeaders_getInstance().ContentType_1);
    var tmp;
    if (tmp0_safe_receiver == null) {
      tmp = null;
    } else {
  ...
  function contentLength(_this__u8e3s4) {
    var tmp0_safe_receiver = _this__u8e3s4.get_headers_ef25jx_k$().get_4u8u51_k$(HttpHeaders_getInstance().ContentLength_1);
  ...
  function Companion_4() {
    ...
    var tmp$ret$2;
    {
      var tmp0_associateBy = this.allStatusCodes_1;
  ...
  function loadMimes$lambda() {
    return function (it) {
      ...
      var tmp_0 = _Char___init__impl__6a9atx(44);
      var index = indexOf$default(line, tmp_0, 0, false, 6, null);
      var tmp$ret$3;
      {
        var tmp$ret$2;
        {
  ...
  function parseQueryString(query, startIndex, limit, decode) {
    ...
    if (startIndex > get_lastIndex_0(query)) {
      tmp = Companion_getInstance_8().Empty_1;
    } else {
      var tmp$ret$1;
      {
  ...
  function URLBuilder_init_$Init$(protocol, host, port, user, password, pathSegments, parameters, fragment, trailingQuery, $mask0, $marker, $this) {
    if (!(($mask0 & 1) === 0))
      protocol = Companion_getInstance_10().HTTP_1;
    if (!(($mask0 & 2) === 0))
      host = '';
    if (!(($mask0 & 4) === 0))
      port = 0;
    ...
    if (!(($mask0 & 64) === 0))
      parameters = Companion_getInstance_8().Empty_1;
    if (!(($mask0 & 128) === 0))
      fragment = '';
    if (!(($mask0 & 256) === 0))
      trailingQuery = false;
  ...
  function applyOrigin($this) {
    ...
    if (tmp$ret$0) {
      ...
      tmp = $this.protocol_1.name_1 === 'file';
    }
    if (tmp)
      return Unit_getInstance();
    $this.host_1 = Companion_getInstance_9().originUrl_1.host_1;
    if ($this.protocol_1.equals(Companion_getInstance_10().HTTP_1))
      $this.protocol_1 = Companion_getInstance_9().originUrl_1.protocol_1;
    if ($this.port_1 === 0)
      $this.port_1 = Companion_getInstance_9().originUrl_1.specifiedPort_1;
  }
  ...
  URLBuilder.prototype.get_pathSegments_2e2s6m_k$ = function () {
    var tmp$ret$2;
    {
      var tmp0_map = this.encodedPathSegments_1;
      var tmp$ret$1;
      {
        var tmp0_mapTo = ArrayList_init_$Create$(collectionSizeOrDefault(tmp0_map, 10));
        var tmp0_iterator = tmp0_map.iterator_jk1svi_k$();
    ...
    var tmp$ret$1;
    {
      ...
      var tmp$ret$0;
      {
        ...
        }
        {
          ...
          if (!(_this__u8e3s4.port_1 === 0) ? !(_this__u8e3s4.port_1 === _this__u8e3s4.protocol_1.defaultPort_1) : false) {
  ...
  function appendTo(_this__u8e3s4, out) {
    out.append_oz4qxs_k$(_this__u8e3s4.protocol_1.name_1);
    var tmp0_subject = _this__u8e3s4.protocol_1.name_1;
  ...
  function takeFromUnsafe(_this__u8e3s4, urlString) {
    ...
    if (schemeLength > 0) {
      ...
      _this__u8e3s4.protocol_1 = Companion_getInstance_10().createOrDefault_wgzdz5_k$(scheme);
      startIndex = startIndex + (schemeLength + 1 | 0) | 0;
    }
    var slashCount = count(urlString, startIndex, endIndex, _Char___init__impl__6a9atx(47));
    startIndex = startIndex + slashCount | 0;
    if (_this__u8e3s4.protocol_1.name_1 === 'file') {
      parseFile(_this__u8e3s4, urlString, startIndex, endIndex, slashCount);
      return _this__u8e3s4;
    }
    if (_this__u8e3s4.protocol_1.name_1 === 'mailto') {
      {
      ...
      loop: while (true) {
        ...
        if (delimiter < endIndex ? equals(new Char(charSequenceGet(urlString, delimiter)), new Char(_Char___init__impl__6a9atx(64))) : false) {
          ...
          if (!(passwordIndex === -1)) {
            ...
            tmp_2.encodedUser_1 = tmp$ret$10;
            ...
            tmp_3.encodedPassword_1 = tmp$ret$12;
          } else {
            ...
            tmp_4.encodedUser_1 = tmp$ret$14;
          }
    ...
    if (startIndex >= endIndex) {
      _this__u8e3s4.encodedPathSegments_1 = equals(new Char(charSequenceGet(urlString, endIndex - 1 | 0)), new Char(_Char___init__impl__6a9atx(47))) ? get_ROOT_PATH() : emptyList();
      return _this__u8e3s4;
    }
    var tmp_5 = _this__u8e3s4;
    var tmp_6;
    if (slashCount === 0) {
      tmp_6 = dropLast(_this__u8e3s4.encodedPathSegments_1, 1);
    } else {
      tmp_6 = emptyList();
    }
    tmp_5.encodedPathSegments_1 = tmp_6;
    var tmp$ret$16;
    {
    ...
    if (pathEnd > startIndex) {
      ...
      if (_this__u8e3s4.encodedPathSegments_1.get_size_woubt6_k$() === 1) {
        var tmp$ret$19;
        {
          var tmp11_isEmpty = first_0(_this__u8e3s4.encodedPathSegments_1);
      ...
      if (tmp_11) {
        ...
        tmp_10 = _this__u8e3s4.encodedPathSegments_1;
      }
      var basePath = tmp_10;
      var tmp_12;
      if (rawPath === '/') {
  ...
  function fillHost(_this__u8e3s4, urlString, startIndex, endIndex) {
    ...
    if ((colonIndex + 1 | 0) < endIndex) {
      ...
      tmp_1.port_1 = toInt(tmp$ret$5);
    } else {
      _this__u8e3s4.port_1 = get_DEFAULT_PORT();
    }
  }
  ...
  function parseFragment(_this__u8e3s4, urlString, startIndex, endIndex) {
    ...
    if (startIndex < endIndex ? equals(new Char(charSequenceGet(urlString, startIndex)), new Char(_Char___init__impl__6a9atx(35))) : false) {
      ...
      tmp.encodedFragment_1 = tmp$ret$1;
    }
  }
  function parseQuery$lambda($this_parseQuery) {
    return function (key, values) {
      $this_parseQuery.encodedParameters_1.appendAll_a9dln0_k$(key, values);
      return Unit_getInstance();
    };
  }
  ...
  function Companion_7() {
    ...
    var tmp$ret$2;
    {
      var tmp0_associateBy = listOf([this.HTTP_1, this.HTTPS_1, this.WS_1, this.WSS_1, this.SOCKS_1]);
      var capacity = coerceAtLeast(mapCapacity(collectionSizeOrDefault(tmp0_associateBy, 10)), 16);
      var tmp$ret$1;
      {
        var tmp0_associateByTo = LinkedHashMap_init_$Create$_0(capacity);
  ...
  function takeFrom_0(_this__u8e3s4, url) {
    _this__u8e3s4.protocol_1 = url.protocol_1;
    _this__u8e3s4.host_1 = url.host_1;
    _this__u8e3s4.port_1 = url.port_1;
    ...
    var tmp$ret$0;
    {
      ...
      {
        appendAll(tmp0_apply, url.encodedParameters_1);
      }
      tmp$ret$0 = tmp0_apply;
    }
  ...
  function appendUrlFullPath(_this__u8e3s4, encodedPath, encodedQueryParameters, trailingQuery) {
    ...
    var tmp$ret$8;
    {
      var tmp0_flatMap = encodedQueryParameters.entries_qbkxv4_k$();
      var tmp$ret$7;
      {
  ...
  function get_hostWithPort(_this__u8e3s4) {
    return _this__u8e3s4.host_1 + ':' + _this__u8e3s4.get_port_wosj4a_k$();
  }
  ...
  function Url$encodedPath$delegate$lambda(this$0) {
    return function () {
      ...
      var tmp_1 = this$0.protocol_1.name_1.length + 3 | 0;
  ...
  function Url$encodedPathAndQuery$delegate$lambda(this$0) {
    return function () {
      var tmp = _Char___init__impl__6a9atx(47);
      var tmp_0 = this$0.protocol_1.name_1.length + 3 | 0;
  ...
  function Url$encodedPassword$delegate$lambda(this$0) {
    return function () {
      ...
      var tmp_2 = this$0.protocol_1.name_1.length + 3 | 0;
  ...
  Url_0.prototype.get_port_wosj4a_k$ = function () {
    ...
    var tmp0_elvis_lhs = tmp$ret$1;
    return tmp0_elvis_lhs == null ? this.protocol_1.defaultPort_1 : tmp0_elvis_lhs;
  };
    ...
    var tmp$ret$1;
    {
      ...
      var tmp$ret$0;
      {
        ...
        }
        {
          ...
          if (_this__u8e3s4.specifiedPort_1 === get_DEFAULT_PORT() ? true : _this__u8e3s4.specifiedPort_1 === _this__u8e3s4.protocol_1.defaultPort_1) {
            tmp0_apply.append_ssq29y_k$(_this__u8e3s4.host_1);
          } else {
  ...
  UrlDecodedParametersBuilder.prototype.names_1q9mbs_k$ = function () {
    var tmp$ret$2;
    {
      var tmp0_map = this.encodedParametersBuilder_1.names_1q9mbs_k$();
      var tmp$ret$1;
      {
        var tmp0_mapTo = ArrayList_init_$Create$(collectionSizeOrDefault(tmp0_map, 10));
        var tmp0_iterator = tmp0_map.iterator_jk1svi_k$();
  ...
  CachingOptions.$metadata$ = classMeta('CachingOptions');
      ...
      try {
        ...
        switch (tmp) {
          ...
          case 1:
            ...
            var tmp_0 = this;
            var tmp_1 = this;
            tmp_1.tmp0_plus1__1 = this.$range_1.get_endInclusive_r07xpi_k$().minus_llf5ei_k$(this.$range_1.get_start_iypx6h_k$());
            tmp_0.limit2__1 = this.tmp0_plus1__1.plus_u6jwas_k$(new Long(1, 0));
            this.state_1 = 2;
            suspendResult = copyTo(this.source0__1, this.$this$writer_1.get_channel_dhi7tm_k$(), this.limit2__1, this);
            if (suspendResult === get_COROUTINE_SUSPENDED()) {
              return suspendResult;
            }
  ...
  OutgoingContent$ReadChannelContent$readFrom$slambda.$metadata$ = classMeta('OutgoingContent$ReadChannelContent$readFrom$slambda', undefined, undefined, undefined, [1], CoroutineImpl.prototype);
  ...
  ReadChannelContent.prototype.readFrom_bry6af_k$ = function (range) {
    ...
    if (range.isEmpty_y1axqb_k$()) {
      ...
      var tmp_1 = Dispatchers_getInstance().Unconfined_1;
  ...
  ProtocolUpgrade.prototype.get_status_jnf6d7_k$ = function () {
    return Companion_getInstance_7().SwitchingProtocols_1;
  };
  ...
  OutgoingContent.prototype.getProperty_4roco9_k$ = function (key) {
    var tmp0_safe_receiver = this.extensionProperties_1;
    return tmp0_safe_receiver == null ? null : tmp0_safe_receiver.getOrNull_dkmqfg_k$(key);
  };
  OutgoingContent.prototype.setProperty_d7s4qe_k$ = function (key, value) {
    if (value == null ? this.extensionProperties_1 == null : false)
      ...
      if (tmp0_safe_receiver == null)
        ...
        tmp0_safe_receiver.remove_kvks5b_k$(key);
      }
    } else {
      var tmp$ret$0;
      {
      ...
      tmp$ret$0.put_ii1a3j_k$(key, value);
    }
  };
  ...
  function TextContent(text, contentType, status) {
    ...
    $l$block: {
      ...
      var tmp1_toByteArray = tmp0_elvis_lhs == null ? Charsets_getInstance().UTF_8__1 : tmp0_elvis_lhs;
      if (tmp1_toByteArray.equals(Charsets_getInstance().UTF_8__1)) {
  ...
  Version.$metadata$ = interfaceMeta('Version');
  ...
  function VersionCheckResult_initEntries() {
    ...
    VersionCheckResult_OK_instance = new VersionCheckResult('OK', 0, Companion_getInstance_7().OK_1);
    VersionCheckResult_NOT_MODIFIED_instance = new VersionCheckResult('NOT_MODIFIED', 1, Companion_getInstance_7().NotModified_1);
    VersionCheckResult_PRECONDITION_FAILED_instance = new VersionCheckResult('PRECONDITION_FAILED', 2, Companion_getInstance_7().PreconditionFailed_1);
  }
  ...
  VersionCheckResult.$metadata$ = classMeta('VersionCheckResult', undefined, undefined, undefined, undefined, Enum.prototype);
  ...
  Grammar.$metadata$ = classMeta('Grammar');
  ...
  StringGrammar.$metadata$ = classMeta('StringGrammar', undefined, undefined, undefined, undefined, Grammar.prototype);
  ...
  AnyOfGrammar.$metadata$ = classMeta('AnyOfGrammar', undefined, undefined, undefined, undefined, Grammar.prototype);
  ...
  RangeGrammar.$metadata$ = classMeta('RangeGrammar', undefined, undefined, undefined, undefined, Grammar.prototype);
  ...
  RawGrammar.$metadata$ = classMeta('RawGrammar', undefined, undefined, undefined, undefined, Grammar.prototype);
  ...
  NamedGrammar.$metadata$ = classMeta('NamedGrammar', undefined, undefined, undefined, undefined, Grammar.prototype);
  ...
  MaybeGrammar.$metadata$ = classMeta('MaybeGrammar', [SimpleGrammar], undefined, undefined, undefined, Grammar.prototype);
  ...
  ManyGrammar.$metadata$ = classMeta('ManyGrammar', [SimpleGrammar], undefined, undefined, undefined, Grammar.prototype);
  function AtLeastOne(grammar) {
    Grammar.call(this);
    this.grammar_1 = grammar;
  }
  ...
  AtLeastOne.$metadata$ = classMeta('AtLeastOne', [SimpleGrammar], undefined, undefined, undefined, Grammar.prototype);
  ...
  SequenceGrammar.$metadata$ = classMeta('SequenceGrammar', [ComplexGrammar], undefined, undefined, undefined, Grammar.prototype);
  ...
  OrGrammar.$metadata$ = classMeta('OrGrammar', [ComplexGrammar], undefined, undefined, undefined, Grammar.prototype);
  function SimpleGrammar() {
  }
  SimpleGrammar.$metadata$ = interfaceMeta('SimpleGrammar');
  function ComplexGrammar() {
  }
  ComplexGrammar.$metadata$ = interfaceMeta('ComplexGrammar');
              ...
              var element_0 = tmp0_iterator_0.next_20eer_k$();
              {
                ...
                if (tmp0_safe_receiver == null)
                  ...
                  var tmp$ret$5;
                  {
                    ...
                    var tmp0_plusAssign = tmp0_safe_receiver.value_1;
  ...
  RegexParser.$metadata$ = classMeta('RegexParser', [Parser]);
  ...
  GrammarRegex.$metadata$ = classMeta('GrammarRegex');
  function toRegex(_this__u8e3s4, groups, offset, shouldGroup) {
    var tmp0_subject = _this__u8e3s4;
    var tmp;
    if (tmp0_subject instanceof StringGrammar) {
      var tmp_0 = Companion_getInstance_1().escape_s7n2bk_k$(_this__u8e3s4.value_1);
      tmp = GrammarRegex_init_$Create$(tmp_0, 0, false, 6, null);
    } else {
      if (tmp0_subject instanceof RawGrammar) {
        tmp = GrammarRegex_init_$Create$(_this__u8e3s4.value_1, 0, false, 6, null);
      } else {
        if (tmp0_subject instanceof NamedGrammar) {
          var tmp_1 = offset + 1 | 0;
          var nested = toRegex$default(_this__u8e3s4.grammar_1, groups, tmp_1, false, 4, null);
          add(groups, _this__u8e3s4.name_1, offset);
          ...
          if (isInterface(tmp0_subject, ComplexGrammar)) {
              ...
              while (tmp0_iterator.hasNext_bitz1p_k$()) {
                var item = tmp0_iterator.next_20eer_k$();
                {
                  ...
                  if (!(tmp1__anonymous__uwfjfc === 0)) {
                    tmp_2 = _this__u8e3s4 instanceof OrGrammar;
                  } else {
                    tmp_2 = false;
                  }
                  if (tmp_2) {
            ...
            if (isInterface(tmp0_subject, SimpleGrammar)) {
              ...
              if (tmp1_subject instanceof MaybeGrammar) {
                tmp_3 = _Char___init__impl__6a9atx(63);
              } else {
                if (tmp1_subject instanceof ManyGrammar) {
                  tmp_3 = _Char___init__impl__6a9atx(42);
                } else {
                  if (tmp1_subject instanceof AtLeastOne) {
                    tmp_3 = _Char___init__impl__6a9atx(43);
                  } else {
              ...
              var tmp_4 = nested_0.regex_1 + new Char(operator);
              tmp = GrammarRegex_init_$Create$(tmp_4, nested_0.groupsCount_1, false, 4, null);
            } else {
              if (tmp0_subject instanceof AnyOfGrammar) {
                var tmp_5 = '[' + Companion_getInstance_1().escape_s7n2bk_k$(_this__u8e3s4.value_1) + ']';
                tmp = GrammarRegex_init_$Create$(tmp_5, 0, false, 6, null);
              } else {
                if (tmp0_subject instanceof RangeGrammar) {
                  var tmp_6 = '[' + new Char(_this__u8e3s4.from_1) + '-' + new Char(_this__u8e3s4.to_1) + ']';
  ...
  function get_origin(_this__u8e3s4) {
    var tmp;
    if (PlatformUtils_getInstance().IS_BROWSER_1) {
      var tmp_0;
      if (!(window === undefined)) {
